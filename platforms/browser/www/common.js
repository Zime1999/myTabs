...
/* harmony import */ var _twitter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./twitter.service */ "./src/app/twitter.service.ts");




var FavoritesService = /** @class */ (function () {
    function FavoritesService(storage, twitterService) {
        this.storage = storage;
        this.twitterService = twitterService;
        this.list = [];
    }
    FavoritesService.prototype.saveTweet = function () {
        var _this = this;
        this.storage.clear();
        this.list.map(function (item) {
            return _this.storage.set(item.id.toString(), item);
        });
    };
    ...
    FavoritesService.prototype.pushToFavorites = function (tweet) {
    ...
    FavoritesService.prototype.splice = function (id) {
        for (var i = 0; i < this.list.length; i++) {
    ...
    FavoritesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"],
            _twitter_service__WEBPACK_IMPORTED_MODULE_3__["TwitterService"]])
    ], FavoritesService);
...
var APP_KEY = 'VJo3sQiVrCc4bMnAtELq8Mjv0';
var APP_SECRET = 'jDBFp9vBEqrqSY2sJdsTV08sgZq3fjJDNpcZ35hYAWgkmCul3j';
var TwitterService = /** @class */ (function () {
    function TwitterService(http, geolocation, loadingController) {
        this.http = http;
        this.geolocation = geolocation;
        this.loadingController = loadingController;
        this.tokenCredentials = window.btoa(APP_KEY + ":" + APP_SECRET);
        this.getHeaders = null;
        this.searchText = "#javascript";
    }
    TwitterService.prototype.issueToken = function () {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8',
            'Authorization': 'Basic ' + this.tokenCredentials
        });
        return this.http.post('https://cors-anywhere.herokuapp.com/https://api.twitter.com/oauth2/token', 'grant_type=client_credentials', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            _this.getHeaders = _this.prebuildHeaders(data.access_token);
     ...
     */
    TwitterService.prototype.prebuildHeaders = function (accessToken) {
        return function (optionalHeaders) {
            return new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + accessToken }, optionalHeaders));
        };
    };
    TwitterService.prototype.getSearchText = function (searchText) {
        this.searchText = searchText;
    };
    TwitterService.prototype.fetchData = function (isToggleOn) {
        var _this = this;
        return this.issueToken()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function () { return isToggleOn ? _this.search(_this.geoSearchString) : _this.search(""); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            _this.data = data;
            return data;
        }));
    };
    TwitterService.prototype.activateGPS = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (pos) {
            _this.lat = pos.coords.latitude;
            _this.long = pos.coords.longitude;
            _this.geoSearchString = "&geocode=" + _this.lat + "," + _this.long + ",5km";
            console.log(_this.geoSearchString);
        }).catch(function (err) { return console.log(err); });
    };
    TwitterService.prototype.fetchMoreData = function () {
        var _this = this;
        var searchPath = "https://cors-anywhere.herokuapp.com/https://api.twitter.com/1.1/search/tweets.json" + this.nextResult;
        var tweets = [];
        var headers = this.getHeaders({ some: 'value' });
        return this.http.get(searchPath, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            _this.nextResult = response.search_metadata.next_results;
            var serverTweets = response.statuses;
            serverTweets.map(function (item) {
                var tweet = {
    ...
    TwitterService.prototype.search = function (geoSearchString) {
        var _this = this;
        var searchPath = "https://cors-anywhere.herokuapp.com/https://api.twitter.com/1.1/search/tweets.json?count=5&q=" + encodeURIComponent(this.searchText) + geoSearchString;
        var tweets = [];
        var headers = this.getHeaders({ some: 'value' });
        return this.http.get(searchPath, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
